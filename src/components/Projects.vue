...
const Projects = ref([
    {
        ...
        title: 'Cloud Crusader',
        description: 'Cloud Crusader is a cloud-based task automation system developed using Django, Python, and Ansible. The system allows users to register, create, schedule, and execute tasks while providing real-time tracking of their progress. Ansible playbooks were integrated to automate server configuration and deployment tasks, making infrastructure management seamless. The project emphasizes efficient task automation for cloud environments, enhancing productivity and reducing manual intervention',
        technologies: ['Django', 'Ansible', 'Websocket','Python'],
        gitURL: '',
        webURL: ''
    },
    {
    ...
    },
    {
        ...
        description: 'This project automates the process of generating blog articles from YouTube video links using AssemblyAI and OpenAI APIs. The system transcribes the audio from YouTube videos into text and then processes the transcription to generate high-quality blog content. The final output is presented directly on a web page, allowing users to review or edit the content before publishing. This project highlights your skills in AI integration and content generation automation.',
        technologies: ['Python', 'Django', 'OpenAI','Api'],
        gitURL: 'https://github.com/GovindHede/ai_blog',
        webURL: ''
    }
